  ...
  return (
    <PageTransition>
      <div className="min-h-screen  p-4 font-sans text-white pb-20 md:pb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 min-h-[calc(100vh-2rem)]">

          {/* Left Hero Section (Spans 3 columns on lg) */}
          <div className="lg:col-span-3 rounded-4xl relative overflow-hidden flex flex-col justify-end p-6 sm:p-10 lg:p-16 min-h-[50vh] lg:min-h-0">
            {/* Background video */}
            <video
          ...
          <div className="lg:col-span-1 grid grid-cols-3 lg:grid-cols-1 lg:flex lg:flex-col gap-4 h-48 sm:h-56 lg:h-auto">
